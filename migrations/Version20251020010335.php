 ...
 */
final class Version20251020010335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD author_books_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A33192488695 FOREIGN KEY (author_books_id) REFERENCES author (id)');
        $this->addSql('CREATE INDEX IDX_CBE5A33192488695 ON book (author_books_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP FOREIGN KEY FK_CBE5A33192488695');
        $this->addSql('DROP INDEX IDX_CBE5A33192488695 ON book');
        $this->addSql('ALTER TABLE book DROP author_books_id');
    }
}
